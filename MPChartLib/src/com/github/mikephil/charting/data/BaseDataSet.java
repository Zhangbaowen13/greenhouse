...
public abstract class BaseDataSet<T extends Entry> implements IDataSet<T>{
    ...
    /**
     * If true then draw more empty  YSL
     */
    protected boolean mDrawBBIValues = false;
    /**
     * Draw more empty InputStream - empty  YSL
     */
    protected InputStream mInputStreamK = null;
    /**
     * Draw more empty InputStream - more  YSL
     */
    protected InputStream mInputStreamD = null;
    ...
    @Override
    public void setDrawBBIValue(boolean enabled)
    {
    	this.mDrawBBIValues = enabled;
    }

    @Override
    public boolean isDrawBBIValue()
    {
    	return mDrawBBIValues;
    }
    @Override
    public void setBBIStreamK(InputStream is){
    	this.mInputStreamK = is;
    }
    @Override
    public InputStream getBBIStreamK()
	{
		return mInputStreamK;
	}
    
    @Override
    public void setBBIStreamD(InputStream is)
    {
    	this.mInputStreamD = is;
    }
    
    @Override
    public InputStream getBBIStreamD()
    {
    	return mInputStreamD;
    }
