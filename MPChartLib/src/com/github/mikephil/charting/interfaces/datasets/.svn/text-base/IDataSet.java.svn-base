...
public interface IDataSet<T extends Entry> {
    ...
    /**
     * Whether to draw more empty
     * author YSL
     * @param enabled
     */
    
    void setDrawBBIValue(boolean enabled);
    /**
     * To obtain more empty index is painting
     * author YSL
     * @return
     */
    boolean isDrawBBIValue();
    /**
     * Set up more than empty indicator diagram InputStream - empty
     * @param is
     */
    void setBBIStreamK(InputStream is);
    /**
     * To obtain more empty InputStream index figure - empty
     * @return
     */
    InputStream getBBIStreamK();
    /**
     * Many Settings, many empty indicator diagram InputStream -
     * @param is
     */
    void setBBIStreamD(InputStream is);
    /**
     * Get empty InputStream index figure - much more
     * @return
     */
    InputStream getBBIStreamD();
