    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_POINTER_DOWN:
            	Log.i("MPChart", "ACTION_POINTER_DOWN");
            ...
            case MotionEvent.ACTION_MOVE:
                if (mTouchMode == DRAG) {
                    ...
                    mChart.disableScroll();
                    Log.d("xxx"," MotionEvent.ACTION_MOVE mTouchMode="+mTouchMode);
                    ...
                    if (mChart.hasNoDragOffset()) {
                        ...
                        if (!mChart.isFullyZoomedOut() && mChart.isDragEnabled()) {
                            ...
                            if (mChart.isHighlightPerDragEnabled() && mChart.getHighlighted() != null) //ysl add mChart.getHighlighted() != null
            ...
            case MotionEvent.ACTION_POINTER_UP:
            	Log.i("MPChart", "ACTION_POINTER_UP");
