...
public class DataNow extends DataSupport {
    ...
    public String getChuanganqiId() {return chuanganqiId;}
    public void setChuanganqiId(String chuanganqiId) {this.chuanganqiId = chuanganqiId;}
    public String getDataname() {return dataname;}
    public void setDataname(String dataname) {this.dataname = dataname;}
    public String getShuju() {return shuju;}
    public void setShuju(String shuju) {this.shuju = shuju;}
