...
public class Tushi extends DataSupport {
    private int id;
    private int chuanganqiId;
    public String tushiData;
    ...
    public String getTushiData() {
        return tushiData;
    }

    public void setTushiData(String tushiData) {
        this.tushiData = tushiData;
    }
